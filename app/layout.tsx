...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="fa" dir="rtl" suppressHydrationWarning><body className={`${vazirmatn.className} ${vazirmatn.variable}`}><UiPreferencesProvider>{children}</UiPreferencesProvider></body></html>}
