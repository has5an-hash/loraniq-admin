...
export default function SettingsPage(){
 ...
 return <LoraniqShell active="settings"><main id="main-content" className="main-content settings-page">
  ...
  <div className="settings-grid">
   ...
   <Choice title="Skin" description="کنترل عمق بصری کارت‌ها و مرزها." field="skin" options={[{value:"soft",label:"Soft",hint:"سایه بسیار نرم"},{value:"bordered",label:"Bordered",hint:"مرز واضح‌تر و سایه کمتر"},{value:"semi-dark",label:"Semi-dark",hint:"Sidebar تیره با محتوای روشن"}]}/>
